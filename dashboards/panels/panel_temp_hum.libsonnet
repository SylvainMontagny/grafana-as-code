...
# PANELS
{
    ...
    main:
        timeSeries.new('${MEASUREMENT} of ${ROOM}')
    ...
    singleView:
        ...
        + row.withPanels([
            ...
            timeSeries.new('${MEASUREMENT} of ${ROOM}')
            + timeSeries.panelOptions.withRepeat('ROOM')
